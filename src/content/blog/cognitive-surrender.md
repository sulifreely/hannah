...
- **认知卸载（cognitive offloading）**：计算器、搜索引擎、GPS 都属于这一类。你把"怎么做"交出去，但"要什么"还攥在自己手里。结果合不合理，你心里有杆秤，不对就介入。
...
类似的信号不止一处。Addy 还提到 Anthropic 的一项研究：用 AI 来**生成代码**学新库的工程师，在后续的理解测验里比对照组低了 **17%**；而用 AI 来**做概念性探究**（提问、探讨取舍）的人，成绩稳得住。同一个工具，**姿势变了，结果就变了**。MIT 那篇《Your Brain on ChatGPT》甚至在神经层面观察到：重度依赖 AI 的写作者，神经连接减弱、对自己刚写的东西记忆更差、更难重建自己的推理过程。
