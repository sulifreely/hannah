...
如果你对这套预算怎么在更具体的工程场景里落地感兴趣，可以接着看[Agent 中 Skill 的执行拓扑](/talks/execution-topology-in-skills/)和[Agent 的 HITL 与 YOLO](/talks/agent-hitl-vs-yolo/)这两篇——里面讲的编排模式和自主程度，分别是协作预算和治理预算的具体落地写法。
